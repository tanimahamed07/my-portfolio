  ...
  return (
    <>
      <nav className="fixed top-0 left-0 w-full z-50 backdrop-blur-md border-b border-gray-200/50 bg-white/80 transition-all duration-300">
        <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-[70px]">
            ...
            <div className="flex-shrink-0">
              <a href="#home" className="text-3xl font-bold tracking-wide text-gray-800">
                TANIM
              </a>
            </div>
        ...
        {/* Mobile Menu Dropdown - Fully Fixed & Smooth */}
        <div
            ...
            {navLinks.map((link, index) => (
              <li key={index} className="w-full text-center">
                <a
                  ...
                  className="block py-3 hover:text-black hover:bg-gray-50/50 transition-all duration-300 rounded-lg mx-8"
                >
                  {link.name}
                </a>
              </li>
      ...
      {/* যাতে কনটেন্ট ন্যাভবারের নিচে না যায় */}
