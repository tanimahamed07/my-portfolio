...
const Banner = () => {
  ...
  return (
    <div
      id="home"
      className="pt-8 sm:pt-12 lg:pt-20 pb-12 sm:pb-16 lg:pb-20 bg-[#FAFAFA]"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center overflow-visible">
          ...
          <div className="lg:col-span-6 relative flex justify-center lg:justify-end items-start order-1 lg:order-0 pt-0 lg:-mt-8 overflow-visible">
            <div className="relative z-10 scale-[0.85] sm:scale-90 lg:scale-100 overflow-visible">
              ...
              >
                <a href="https://ibb.co.com/p6GqvdqK">
                  <img
                    src="https://i.ibb.co.com/DPsdDQdM/IMG-1357.avif"
                    alt="Tanim Ahamed"
              ...
              {/* Floating Elements */}
              {/* Command + C */}
              <div className="absolute top-4 -right-6 sm:top-10 sm:-right-10 bg-white p-2 sm:p-3 rounded-full shadow-lg flex items-center gap-2 transform rotate-12 transition-all duration-300 hover:scale-105 hover:rotate-6 z-20">
              ...
              {/* Command + V */}
              <div className="absolute top-[35%] -right-8 sm:-right-14 bg-white p-2 sm:p-3 rounded-xl shadow-2xl flex items-center gap-3 animate-bounce z-10">
                <BiCodeAlt className="text-xl sm:text-2xl text-gray-700" />
                <div>
                  <p className="text-[10px] sm:text-xs text-gray-500 leading-none">
                    Command + v
              ...
              {/* Bug Fix */}
              <div className="absolute bottom-6 -left-4 sm:-left-10 bg-white p-2 sm:p-3 rounded-xl shadow-lg flex items-center gap-3 transform -rotate-6 transition-all duration-300 hover:scale-105 hover:rotate-0 z-20 border border-orange-100">
                <AiOutlineFire className="text-xl sm:text-2xl text-orange-500" />
                <div>
                  <p className="font-bold text-xs sm:text-sm text-gray-800 leading-none">
                    Bug Fix
                  </p>
